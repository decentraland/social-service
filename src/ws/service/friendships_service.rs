...
use crate::{
    ws::app::MyContext, FriendshipsServiceServer, RequestEvents, ServerStreamResponse,
...
impl FriendshipsServiceServer<MyContext> for MyFriendshipsService {
    async fn get_friends(&self, _context: Arc<MyContext>) -> ServerStreamResponse<Users> {
        todo!()
    }
    async fn get_request_events(&self, _context: Arc<MyContext>) -> RequestEvents {
        todo!()
    }
